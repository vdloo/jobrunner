...
class TestRegisterCapability(TestCase):
    def setUp(self):
        unloaded_script = """
from json import dumps
from jobrunner.settings import CAPABILITIES
print(dumps(list(CAPABILITIES.keys())))
        """
        loaded_script = """
from json import dumps
...
print(dumps(list(CAPABILITIES.keys())))
    ...
    def test_register_job_does_not_register_unloaded_capabilities(self):
    ...
    def test_register_job_registers_loaded_capabilities(self):
        ret = loads(check_output(
